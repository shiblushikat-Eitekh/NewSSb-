...
var Validator = {
    ...
    //This function verifies that the specified string element is having exact length specified
    validateExactLength: function(element, exactLength, errorMessage) {
        var isValid;
        isValid = true;

        if(element != null && element.length != exactLength) {
            Validator.addError(errorMessage);
            isValid = false;
        }
        return isValid;
    ...
    // This function verifies that the specified string element consists only numbers.
    // If the validation fails, the specified errorMessage is added to the error message queue.
    validateNumber: function(element, errorMessage) {
        var isValid;
    ...
    // Validates if two inputs are equal, performing case-insensitive comparison for strings.
    validateInputs: function(element, compareWith, errorMessage) {
        var isValid;

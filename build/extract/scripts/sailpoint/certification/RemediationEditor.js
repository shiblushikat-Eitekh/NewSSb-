Ext.define('SailPoint.certification.RemediationEditor', {
    ...
    getValues : function(){
        ...
        for (var i=0;i<this.editableEntitlements.length;i++){
            ...
            var val = {
                newOperation: Ext.getCmp(this.getOperationSelectorId(item)).getValue(),
                newValue: newVal,
    ...
    showRevocationDetailsPanel : function(remediationDetails, useManagedAttributes, certificationConfig, readOnly, certificationItem){
        ...
        for (var i=0;i<remediationDetails.length; i++){
            ...
            if (itemEditable){
                if (item.inputType == 'select'){
                    ...
                    html +="<td valign='top'><div id='remedValue_"+item.id+"' style='width:150px'></div></td>";
                } 
            } else {
                ...
                if (item.attribute) {
                    if (useManagedAttributes) {
                        ...
                        new SailPoint.LinkAttributeValueSuggest({
                            ...
                            certificationItem: certificationItem.getId(),
                            isPermission: false,
                            initialValue : itemValue,
                            forceSelection: true,
                            allowBlank: false,

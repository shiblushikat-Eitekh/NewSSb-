...
Ext.define('SailPoint.form.editor.FormEditor', {
    ...
    initComponent : function() {
        ...
        this.formOwnerScript = new Ext.form.TextArea ({
            ...
            height: 50,
            hidden: true,
            readOnly: !(SailPoint.configData.EDIT_SCRIPTS_ACCESS || (SailPoint.SYSTEM_ADMIN === 'true')),
            disabled: !(SailPoint.configData.EDIT_SCRIPTS_ACCESS || (SailPoint.SYSTEM_ADMIN === 'true'))
        });
        ...
        this.previewPanel = new Ext.Panel ({
            ...
            hidden : true,
            autoScroll: true,
            html: '<div class="sp-ui-app"><sp-form-preview sp-config-key="previewFormJSON"></sp-form-preview></div>'
        });
        ...
        this.errorPanel = new Ext.panel.Panel ({
            ...
            header: {
                titlePosition: 0,
                html: "<span id='errorIcon' class='errorIcon' ></span>" +
                      "<span id='closeIcon' class='closeIcon' onclick='me.displayError(false)' ></span>"
            }
        });

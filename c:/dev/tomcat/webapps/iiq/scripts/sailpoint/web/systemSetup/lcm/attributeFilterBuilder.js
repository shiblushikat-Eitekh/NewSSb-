...
Ext.define('SailPoint.systemSetup.lcm.AttributeFilterBuilder', {
    ...
    initComponent: function() {
        ...
        this.html = '<div id="' + this.id + 'FilterBuilderBody"></div>';
    ...
    save: function() {
        Ext.getDom(this.filterBinding).value = Ext.JSON.encode(this.getFilterObj(false));
    },
...
Ext.define('SailPoint.systemSetup.lcm.AttributeCoder', {
    ...
    encoderTopLevelTpl: new Ext.XTemplate(
        '<table class="spTable" style="margin-left:5px">',

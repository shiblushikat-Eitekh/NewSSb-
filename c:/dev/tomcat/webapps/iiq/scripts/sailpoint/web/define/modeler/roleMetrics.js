            ...
            tbar: [{
                ...
                handler: function() {
                    ...
                    if (isExcludeSelected) {
                        ...
                        Ext.getDom('metricsDrilldownCertificationForm:selectedNames').value = JSON.stringify(identitiesDrilldown.getSelectedNames());
...
SailPoint.Role.Metrics.displayEntitlementsDrilldown = function(roleId, metric) {
    ...
    if (!entitlementsDrilldown) {
        entitlementsDrilldown = new Ext.Window({
            ...
            title: SailPoint.Role.Metrics.MetricDisplayNames[metric],
            html: '<div class="spGrayBackground"><div id="entitlementsDisplayContent" class="spContent"><div id="roleMetricsEntitlementsDisplay"></div></div></div>',
            width: 768,
            height: 600,
            layout: 'fit',
            autoScroll : true,

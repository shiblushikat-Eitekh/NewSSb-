...
Ext.define('SailPoint.systemSetup.QuickLinkPopulationEditor', {
    ...
    initRules: function() {
        ...
        this.filterRuleSelector =
            SailPoint.SuggestFactory.createSuggest('rule', 'FilterRuleDiv', null, '#{msgs.select_rule}', {
                extraParams: { ruleType: 'IdentityFilterGenerator' },
                binding: 'FilterRule',
                formBinding: 'editForm',
                renderTo: 'FilterRuleDiv',
                margin: '0 0 0 10'
            });
        this.setInitialValue(this.filterRuleSelector, Ext.getDom('editForm:FilterRule'), Ext.getDom('editForm:FilterRuleName'));
        this.filterRuleSelector.on('select', SailPoint.systemSetup.QuickLinkPopulationEditor.pageChangedHandler, this);
        this.filterRuleSelector.on('change', SailPoint.systemSetup.QuickLinkPopulationEditor.filterRuleChangedHandler, this);
    },
    ...
    updateRuleSelector: function() {
        ...
        this.filterRuleSelector.getStore().load();
    },
    ...
    getRuleName: function(selectorType) {
        ...
        } else if (selectorType === 'filterRule') {
            return this.filterRuleSelector.getRawValue;
        }
    },
    ...
    statics: {
         ...
         * because if a user clicks in and out of the combobox without even changing a value, it will fire
         */
        filterRuleChangedHandler: function(suggest, newValue, oldValue, eOpts) {
            SailPoint.systemSetup.QuickLinkPopulationEditor.pageChangedHandler(suggest, newValue, oldValue, eOpts);
            console.log('filterRuleChangedHandler');
            Ext.getDom('editForm:FilterRuleName').value = suggest.getRawValue();
        },
        ...
        initRequestControl : function() {
            ...
            if (Ext.getDom(domId)) {
                  ...
                  SailPoint.systemSetup.QuickLinkPopulationEditor.applyFilterRule();
        ...
        applyFilterRule: function() {
            var enableFilterRule = Ext.getDom('editForm:EnableFilterRule').checked;

            if (enableFilterRule) {
                Ext.getDom('FilterRuleRow').style['display'] = '';
            } else {
                Ext.getDom('FilterRuleRow').style['display'] = 'none';
            }
        },

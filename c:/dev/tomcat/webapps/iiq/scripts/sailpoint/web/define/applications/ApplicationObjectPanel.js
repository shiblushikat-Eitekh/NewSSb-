...
Ext.define('SailPoint.define.applications.ApplicationObjectPanel', {
    ...
    statics: {
        createId: function(prefix) {
            return prefix + '_Tab'; /*Changing this to _Tab as it is going to be conflict when namespace = app*/
        }
    },
    ...
    updateTabPanelLayout: function() {
        Ext.getCmp(this.spNamespace + '_Tab').updateLayout(); /*Changing this to _Tab as it is going to be conflict when namespace = app*/
    },

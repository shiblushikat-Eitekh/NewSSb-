...
Ext.define('SailPoint.grid.PagingCheckboxGrid', {
    ...
    */
    ...
    /**
     * @returns {Array} Returns an Array of the Names of all selected records.
     */
    ...
    /**
    * {boolean} returns true if store's proxy has data in the extraparams which are used to filter the data results
    */
    isGridsStoreFiltered: function() {
        return this.selModel.isStoreFiltered();
    },
    ...
    */
     ...
     */
    destroy: function(){
      //removing the 'click' listener event to avoid confusion when recreating the grid
      this.selModel.removeListener('click', this.selModel.selectAllMenuClick, this.selModel);
    },
